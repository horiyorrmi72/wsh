...
export class TeamsComponent {
  teams = [
    ...
    },
    {
      ...
      imagePath: './assets/images/Dr Omowumi Okedare.png',
      designation: 'Directors',
      description: 'Board member'
    },
    {
      name: 'Wuraoluwa Ayodele',
      imagePath: './assets/images/Wuraoluwa Ayodele.png',
      designation: 'Directors',
      description: 'Board member'
    },
    {
      name: 'Folake Ajayi Esq',
      imagePath: './assets/images/Folake Ajayi Esq.jpg',
      designation: 'Directors',
      description: 'Board member'
    },
    {
    ...
    },
    {
      ...
      imagePath: './assets/images/Omobawumi Ebube Ayodele.jpg',
      designation: 'Staff',
      description: 'Assistant Program Manager'
    },
    {
      name: 'Oluwaseun Akintola',
      imagePath: './assets/images/Oluwaseun Akintola.jpg',
      designation: 'Staff',
      description: 'Program Officer'
    },
    {
      name: 'Oluwayemisi Emmanuel',
      imagePath: './assets/images/Oluwayemisi Emmanuel.png',
      designation: 'Staff',
